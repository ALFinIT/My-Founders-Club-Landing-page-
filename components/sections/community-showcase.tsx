          ...
          >
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <motion.div
                        className="w-14 h-14 rounded-full bg-gradient-to-br from-orange-500/30 to-teal-500/20 flex items-center justify-center"
            ...
            >
              ...
              {[
                ...
                >
                  <div className="w-6 h-6 rounded-full bg-gradient-to-br from-orange-500 to-teal-500 flex items-center justify-center flex-shrink-0 mt-1">
