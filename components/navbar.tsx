  ...
  return (
    <>
      ...
      {user && !isLoading && isUserMenuOpen && (
        <motion.div
          ref={dropdownRef}
          className="fixed top-24 w-72 bg-white/25 backdrop-blur-lg rounded-2xl border-2 border-white/40 shadow-2xl p-6 z-[9999]"
          style={{ right: '450px' }}
        ...
        >
          ...
          <div className="space-y-2 mb-4">
            <Link href="/settings">
              <motion.button
                className="w-full flex items-center gap-3 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg transition-colors text-white text-sm"
                whileHover={{ x: 4 }}
            ...
            <motion.button
              ...
              className="w-full flex items-center gap-3 px-4 py-2 bg-white/10 hover:bg-red-500/30 rounded-lg transition-colors text-white text-sm"
              whileHover={{ x: 4 }}
            >
          ...
          <div className="border-t border-white/20 pt-4">
            ...
            <div className="flex items-center justify-center gap-3">
              <a href="https://twitter.com/my_founders_club" target="_blank" rel="noopener noreferrer" className="p-2 text-white bg-white/10 hover:bg-white/20 rounded-full transition-all flex items-center justify-center" title="X (Twitter)">
              ...
              <a href="https://linkedin.com/company/my-founders-club" target="_blank" rel="noopener noreferrer" className="p-2 text-white bg-white/10 hover:bg-white/20 rounded-full transition-all flex items-center justify-center" title="LinkedIn">
              ...
              <a href="https://instagram.com/my_founders_club" target="_blank" rel="noopener noreferrer" className="p-2 text-white bg-white/10 hover:bg-white/20 rounded-full transition-all flex items-center justify-center" title="Instagram">
